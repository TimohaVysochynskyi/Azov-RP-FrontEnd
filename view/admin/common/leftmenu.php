...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item"><a href="/admin/"><i class="fas fa-home"></i><span class="menu-title" data-i18n="">Головна</span></a>
        </li>
        <li class=" nav-item"><a href="/admin/roulette"><i class="fas fa-money"></i><span class="menu-title" data-i18n="">Рулетка</span></a>
        </li>
         <li class=" nav-item"><a href="/admin/news"><i class="fas fa-list"></i><span class="menu-title" data-i18n="">Новини</span></a>
        </li>
