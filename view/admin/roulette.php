          ...
          <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="basic-layout-tooltip">Налаштування рулетки</h4>
                  ...
                  <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-underline no-hover-bg">
                      <li class="nav-item">
                        ...
                        href="#item" aria-expanded="true">Робота з предметами</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="base-tab32" data-toggle="tab" aria-controls="tab32" href="#category"
                        aria-expanded="false">Робота з категориями рулетки</a>
                      </li>
                      ...
                      <div role="tabpanel" class="tab-pane active" id="item" aria-expanded="true" aria-labelledby="base-tab31">
                        <button type="button" class="btn btn-success block btn-lg" data-toggle="modal"
                          data-target="#create_item">
                           Додати елемент в рулетку
                          </button>
                          <br><br><br><br>

                          <div class="card-content collapse show ">
                <h4 class="card-title" id="basic-layout-tooltip">Список елементів рулетки</h4>
              ...
              if($statement->rowCount())
              {
               ...
               while($roulette=$statement->fetch()) { 
                            ...
                            <div class='modal-dialog' role='document'>
                              ...
                              <div class='modal-content'>
                                <div class='modal-header'>
                                  <h4 class='modal-title' id='myModalLabel1'>Редагування предмета: <b>{$roulette['i_name']}</b></h4>
                                ...
                                <div class='modal-body'>
                                  ...
                                  <div class='col-md-12'>
                                    <div class='form-group'>
                                      <label for='projectinput1'>Назва предмета</label>
                                  ...
                                  <div class='col-md-12'>
                                    <div class='form-group'>
                                      <label for='projectinput5'>Категорія</label>
                                  ...
                                  <div class='col-md-12'>
                                    <div class='form-group'>
                                      <label for='projectinput2'>Ймовірність</label>
                                      <input type='text' id='projectinput2' class='form-control' value='{$roulette['i_change']}'
                                      name='i_change'>
                                    </div><br>
                                    <p>Якщо ви додаєте певний предмет, то на початок і на кінець пишіть одне й те саме чисто<br>.
                                    Приклад: Скіни або авто (562), а якщо донат або гроші (1000, 100000)</p>
                                  </div>
                                  
                                  <div class='col-md-6'>
                                    <div class='form-group'>
                                      <label for='projectinput2'>Початок рандому</label>
                                  ...
                                  <div class='col-md-6'>
                                    <div class='form-group'>
                                      <label for='projectinput2'>Кінець рандому</label>
                                ...
                                <div class='modal-footer'>
                                  ...
                                  <button type='button' class='btn grey btn-outline-secondary' data-dismiss='modal'>Відміна</button>
                  ...
                  ";
                    ...
                    $button_delete = '<button type="button" class="btn btn-danger" onclick="DeleteRouletteItem('.$roulette['id'].');">Видалити</button>';
                echo "<tr>
                        ...
                        <td><button type='button' class='btn btn-success ' data-toggle='modal'
                          data-target='#edit-{$roulette['id']}'>Редагувати</button>
                        {$button_delete}</td>
                      </tr>"; } }?>
                          ...
                          aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              ...
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h4 class="modal-title" id="myModalLabel1">Створення предмета для рулетки</h4>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                  </button>
                                </div>
                                <div class="modal-body">
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      <label for="projectinput2">Картинка</label>
                                      <input type="text" id="projectinput2" class="form-control" placeholder="Посилання на картинку"
                                      name="i_images">
                                    </div>
                                  </div>
                                  <div class="col-md-12">
               ...
               while($category=$statement->fetch()) {
                ...
                echo "<option value='{$category['id']}'>{$category['name']}</option>"; 
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label for="projectinput2">Початок рандому</label>
                                      <input type="text" id="projectinput2" class="form-control" placeholder="З якого числа буде починатись рандом"
                                      name="i_start_rand">
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label for="projectinput2">Кінець рандому</label>
                                      <input type="text" id="projectinput2" class="form-control" placeholder="До якого числа буде працювати рандом"
                                      name="i_end_rand">
                                    </div>
                                  </div>
                                </div>
                      ...
                      <div class="tab-pane" id="category" aria-labelledby="base-tab32">
                        <button type="button" class="btn btn-success block btn-lg" data-toggle="modal"
                          ...
                          <div class="card-content collapse show ">
                <h4 class="card-title" id="basic-layout-tooltip">Список категорій</h4>
                <div class="table-responsive">
                  <table class="table table-basic mb-0">
                    <thead>
                      <tr>
              ...
              if($statement->rowCount())
              {
               ...
               while($category=$statement->fetch()) { 
                  ...
                  <div class='modal fade text-left' id='editcategory-{$category['id']}' tabindex='-1' role='dialog' aria-labelledby='myModalLabel1'
                          aria-hidden='true'>
                            <div class='modal-dialog' role='document'>
                              ...
                              <div class='modal-content'>
                                <div class='modal-header'>
                                  <h4 class='modal-title' id='myModalLabel1'>Редагування категорії: <b>{$category['name']}</b></h4>
                                  <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                                    <span aria-hidden='true'>&times;</span>
                                  </button>
                                </div>
                                <div class='modal-body'>
                                  ...
                                  <div class='col-md-12'>
                                    <div class='form-group'>
                                      <label for='projectinput1'>Назва категорії</label>
                  ...
                  ";
                    ...
                    $button_delete = '<button type="button" class="btn btn-danger" onclick="DeleteRouletteCategory('.$category['id'].');">Відміна</button>';
                echo "<tr>
                        <th scope='row'>{$category['id']}</th>
                        <td>{$category['name']}</td>
                   
                        <td><button type='button' class='btn btn-success ' data-toggle='modal'
                          data-target='#editcategory-{$category['id']}'>Редагувати</button>
                        {$button_delete}</td>
                      </tr>"; } }?>
                          ...
                          aria-hidden='true'>
                            <div class='modal-dialog' role='document'>
                              ...
                              <div class='modal-content'>
                                <div class='modal-header'>
                                  <h4 class='modal-title' id='myModalLabel1'>Створення категорії</h4>
                                  <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                                    <span aria-hidden='true'>&times;</span>
                                  </button>
                                </div>
                                ...
                                <div class='modal-footer'>
                                  ...
                                  <button type='button' class='btn grey btn-outline-secondary' data-dismiss='modal'>Відміна</button>
                                  <button type='submit' class='btn btn-success'>Створення</button>
                                </div>
                              </div>
                              </form>
                            </div>
