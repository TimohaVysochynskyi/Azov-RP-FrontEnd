                      ...
                      <div class="form-body">
                        ...
                        <div class="form-group">
                          ...
                          <select id="issueinput6" name="s_md5" class="form-control">
                            <option value='<?php echo $ucp_settings['s_md5']?>'>Стан: <?php if($ucp_settings['s_md5']) echo "Увімкнуто"; else echo "Вимкнено";?></option>
                            <?php if($ucp_settings['s_md5']) echo "<option value='0'>Вимкнути</option>"; else echo "<option value='1'>Увімкнути</option>";?>
                          </select>
                        </div>
                        <div class="form-group">
