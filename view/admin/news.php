                  ...
                  <div class="card-body">
                    ...
                    <tbody>
                    	<?php
							...
							$statement = $db->prepare("SELECT * FROM `ucp_news` ORDER BY n_id ASC LIMIT 30");
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h4 class="modal-title" id="myModalLabel1">Редагування новини - '.$news['n_title'].'</h4>
                                ...
                                <form method="POST" action="/engine/obr/admin.php">
                                  ...
                                  <div class="row">
			                          ...
			                          <div class="col-lg-12">
			                            <div class="form-group">
			                              <label for="projectinput2">Посилання на відео</label>
			                          ...
			                          <div class="col-lg-12">
			                          	<div class="form-group">
				                          <label for="projectinput8">Опис новини</label>
                                ...
                                <form method="POST" action="/engine/obr/admin.php">
                                  ...
                                  <div class="row">
			                          ...
			                          <div class="col-lg-12">
			                            <div class="form-group">
			                              <label for="projectinput1">Назва новини</label>
			                              <input type="text" id="projectinput1" class="form-control" placeholder="Оновлення на сервері"
			                              name="n_title">
			                            </div>
			                          </div>
			                          <div class="col-lg-12">
			                          ...
			                          <div class="col-lg-12">
			                            <div class="form-group">
			                              <label for="projectinput2">Посилання на відео</label>
			                              <input type="text" id="projectinput2" class="form-control" placeholder="youtube.com/video"
			                              name="n_url">
			                            </div>
			                          </div>
			                          <div class="col-lg-12">
				                          ...
				                          <textarea id="projectinput8" rows="5" class="form-control" name="n_text" placeholder="..."></textarea>
				                        </div>
			                          </div>
